#سیستم مدیریت زمان 
#یک سیستم مدیریت شخصی چندماژوله در محیط ترمینال که با مفاهیم پایه و میان‌رده پایتون ساخته شده و امکاناتی شبیه اپلیکیشن‌های واقعی ارائه می‌دهد. و امکاناتی از جمله یک دفتر خاطرات ، دفتر هزینه ها ، و یک دفتر برنامه ریزی روزانه دارد و همچنین قابلیت اضافه کردن ادمین دارد 
# لیست ادمینتور 
admin_information = [
